      ...
      <ul class="d-flex align-items-center">
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">{{ $session_full_name }}</span>
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile" style="">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('users/save/'. $session_key) }}">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ route('loans/pending') }}">
              <i class="bi bi-circle"></i><span>Pendentes</span>
            </a>
          </li>
          <li>
            <a href="{{ route('loans/awaiting_disbursement') }}">
	...
	<li class="nav-heading">ADMINISTRAÇÃO</li>
      ...
      <li class="nav-item">
        ...
        <ul id="instituition-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ route('institution/entities') }}">
              <i class="bi bi-circle"></i><span>Entidades</span>
            </a>
          </li>
          <li>
            <a href="{{ route('institution/branches') }}">
              <i class="bi bi-circle"></i><span>Divisões</span>
            </a>
          </li>
          <li>
            <a href="{{ route('institution/entity_employers') }}">
      ...
      <li class="nav-item">
        ...
        <ul id="documents-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ route('documents/terms_and_conditions') }}">
              <i class="bi bi-circle"></i><span>Termos e condições</span>
            </a>
          </li> 
          <li>
            <a href="{{ route('documents/kyc') }}">
      ...
      <li class="nav-item">
        ...
        <ul id="simulator-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ route('simulator/parameters') }}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('rejection_reasons') }}">
