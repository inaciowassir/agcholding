                ...
                <form name="" action="" method="POST" id="userForm">
                    <div class="col-sm-10">
                        <div class="form-floating mb-3">
                          ...
                          value="<?php if(!empty($rejectionReason)): ?><?php echo trim($rejectionReason[$key]['reason']) ?><?php endif ?>">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="floatingSelect" aria-label="Seleccionar tipo" name="type">
                                ...
                                <?php if(!empty($rejectionReason) && $rejectionReason[$key]['type'] == 'Documento'): ?> <?php echo ' selected ' ?> <?php endif ?>
                                >Documento</option>
                                <option value="Contracto"
                                <?php if(!empty($rejectionReason) && $rejectionReason[$key]['type'] == 'Contracto'): ?> <?php echo ' selected ' ?> <?php endif ?>
                                >Contracto mutuo</option>
                                <option value="Emprestimo"
                                <?php if(!empty($rejectionReason) && $rejectionReason[$key]['type'] == 'Emprestimo'): ?> <?php echo ' selected ' ?> <?php endif ?>
                                >Emprestimo</option>
                            </select>
...
$(document).ready(function() {
    $("#userForm").submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo route('rejection_reasons/save') ?>",
            method: "POST",
            dataType: "JSON",
            data: userData,
            beforeSend: function() {
                ...
                if (response.status == "success" && status == "success") {
                    Swal.fire({
                      ...
                      icon: "success"
                    	...
                    	window.location.href = "<?php echo route('rejection_reasons') ?>";
                    });
                }
