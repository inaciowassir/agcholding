...

{
	 ...
	 * This function calls the prefix method as channing to the route
	 ...
	 * This function calls the where method as channing to the route
...

	{
...

		{
			...
			throw new \Exception("The [where] function expects one parameter (of array type) or two parameters of type string, zero passed");
...

		{
...

			{
				...
				throw new \Exception("You passed one argument, must be type of array or pass the second argument of type string");
...

		{
			...
			throw new \Exception("The where function expects one (of array type) or two arguments (of type string), more than three passed");
